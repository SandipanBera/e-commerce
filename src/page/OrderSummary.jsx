      ...
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto ">
        ...
        <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
          <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
            <div className="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8  w-full gap-y-3">
              ...
              {cart.items.map((item) => (
                ...
                >
                  ...
                  <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-center h-full w-full space-y-4 md:space-y-0">
                    ...
                    <div className="flex justify-between space-x-8 items-start w-full">
                      <div>
                        {" "}
                        <span className="text-base dark:text-white xl:text-sm leading-6  text-gray-500 line-through">
                        &#8377;
                              {(
                                item.product.price / (1 -.1)
                  ...
                  <div className="flex justify-between items-center w-full">
                    <p className="text-base dark:text-white leading-4 text-gray-800">
                      ...
                      <span className="bg-gray-200 p-1 text-xs font-medium dark:bg-white dark:text-gray-800 leading-3 text-gray-800">
                       {cart?.coupon?.couponCode ?cart?.coupon?.couponCode:'none' }
                      </span>
                    </p>
                    <p className="text-base dark:text-gray-300 leading-4 text-gray-600">
                    &#8377; {cart?.coupon?.discountValue ? cart?.coupon?.discountValue:'0' }
                    </p>
                  </div>
                  <div className="flex justify-between items-center w-full">
                    <p className="text-base dark:text-white leading-4 text-gray-800">
